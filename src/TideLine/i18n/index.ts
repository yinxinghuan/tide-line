...
const DICT: Record<string, [string, string, string, string]> = {
  brand: ['Wild Line', '野线', 'Wild Line', 'Wild Line'],
  swipeHint: ['Swipe to clear & rescue', '滑动清理·解救生灵', 'Desliza para limpiar', 'Deslize para limpar'],
  restored: ['Habitat restored', '栖息地已修复', 'Hábitat restaurado', 'Habitat restaurado'],
  piecesCleared: ['{n} hazards cleared', '清走了 {n} 处威胁', '{n} amenazas retiradas', '{n} ameaças removidas'],
  wildlifeBack: ['Wildlife is coming home', '生灵正在回归', 'La fauna regresa', 'A vida selvagem volta'],
  seeCoast: ['See the wild', '看看野境', 'Ver lo salvaje', 'Ver a natureza'],
  cleanAnother: ['Restore another', '再修一处', 'Restaurar otra', 'Restaurar outra'],
  cleanFirst: ['Start restoring', '开始修复', 'Empezar', 'Começar'],
  coastTitle: ['The Wild', '共建野境', 'Lo Salvaje', 'A Natureza'],
  collectiveLitter: ['hazards cleared together', '处威胁被清除', 'amenazas retiradas', 'ameaças removidas'],
  ...
  together: ['Together we cleared', '我们一起清除了', 'Juntos limpiamos', 'Juntos limpamos'],
  ...
  wildlifeReturned: ['Wildlife that returned', '回归的生灵', 'Fauna que regresó', 'Vida que voltou'],
  releaseTitle: ['Release wildlife here', '放生生灵', 'Suelta fauna aquí', 'Solte vida aqui'],
